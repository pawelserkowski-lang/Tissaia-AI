...
title TISSAIA AI - Chrome App Launcher
color 0B
...
echo.
echo              Architect Engine - Chrome App Mode
echo  ======================================================
echo.
...
:: ===============================================
:: [5] Start servers MINIMIZED to system tray
:: ===============================================
...
:: ===============================================
:: [6] Launch Chrome in App Mode
:: ===============================================
echo [6/6] Launching Chrome App...
echo.
echo  ======================================================
echo   TISSAIA AI is running in Chrome App mode!
echo.
